...
import FaceRecognition.detect_face as detect_face
    ...
    def collect_data(self):
        ...
        with tf.Graph().as_default():
            ...
            with sess.as_default():
                pnet, rnet, onet = detect_face.create_mtcnn(sess, './FaceRecognition/npy')
                    ...
                    if not os.path.exists(output_filename):
                        try:
                            ...
                            if nrof_faces > 0:
                                ...
                                scaled_temp = scipy.misc.imresize(cropped_temp, (image_size, image_size), interp='bilinear')

                                nrof_successfully_aligned += 1
                                scipy.misc.imsave(output_filename, scaled_temp)
